...
let exerciseList = [
  ...
  { type: REPITITION_EXERCISE, name: "Weight Training - Squats" },
  { type: REPITITION_EXERCISE, name: "Weight Training - Deadlifts" },
  { type: REPITITION_EXERCISE, name: "Weight Training - Bench Press" },
  { type: REPITITION_EXERCISE, name: "Weight Training - Biceps Arm Curl" },
